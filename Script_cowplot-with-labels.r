# ============================================================================
# Per-profile bathymetric depth histograms of the Mariana Trench (R, ggplot2).
...
# совемещает множество графиков. Подписывает ярлыки. Совместную легенду не делает.
library(cowplot)
figure <-plot_grid(
...
figure_all_cowplot<- annotate_figure(
    figure,
...
ggsave("figure_all_cowplot.pdf", device = cairo_pdf, fallback_resolution = 300, width = 210, height = 297, units = "mm")
